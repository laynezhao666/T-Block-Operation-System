...
require (
	...
	trpc.group/trpc-go/trpc-database/goredis v1.0.0 // indirect
	trpc.group/trpc-go/trpc-database/gorm v1.0.0 // indirect
	trpc.group/trpc-go/trpc-database/mongodb v1.0.0 // indirect
	trpc.group/trpc-go/trpc-filter/recovery v1.0.0 // indirect
	trpc.group/trpc-go/trpc-filter/validation v1.0.1 // indirect
	trpc.group/trpc-go/trpc-metrics-runtime v1.0.0 // indirect
	trpc.group/trpc-go/trpc-selector-dsn v1.1.0 // indirect
	trpc.group/trpc/trpc-protocol/pb/go/trpc v1.0.1 // indirect
)

replace etrpc-go => ../etrpc-go
