...
(
    ...
    `device_type_zh` varchar(255)          DEFAULT NULL,
...
(
    ...
    `device_gid`             varchar(100) NOT NULL COMMENT '告警设备GID',
    `device_number`          varchar(255) NOT NULL,
    `device_type_zh`         varchar(255) DEFAULT '',
    `box_name`               varchar(100) NOT NULL COMMENT '方仓名，搜索用',
    `room_name`              varchar(100) NOT NULL COMMENT '房间名，搜索用',
  ...
  AUTO_INCREMENT = 8970517
  DEFAULT CHARSET = utf8;


-- `tbos`.t_alarm_mworker definition

CREATE TABLE `t_alarm_mworker`
(
...
CREATE TABLE `t_collector_device`
(
    `id`                   bigint(20)   NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
(
    ...
    `protocol_type`    varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '协议类型',
